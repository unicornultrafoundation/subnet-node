...
func (c *calculatedRemote) Apply(ip netip.Addr) *subnet.Ip4AndPort {
...
func (c *calculatedRemote) apply4(ip netip.Addr) *subnet.Ip4AndPort {
	...
	return &subnet.Ip4AndPort{Ip: (maskIp & mask) | (intIp & ^mask), Port: c.port}
}

func (c *calculatedRemote) apply6(ip netip.Addr) *subnet.Ip4AndPort {
	//TODO: IPV6-WORK

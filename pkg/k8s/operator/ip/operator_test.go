...
import (
	...
	cmocks "github.com/unicornultrafoundation/subnet-node/core/k8s/mocks"
	...
	clfromctx "github.com/unicornultrafoundation/subnet-node/core/k8s/types/v1/fromctx"
	mlbmocks "github.com/unicornultrafoundation/subnet-node/core/k8s/types/v1/mocks/kube/operators/clients/metallb"
	cutil "github.com/unicornultrafoundation/subnet-node/core/k8s/util"
...
func TestIPOperatorRun(t *testing.T) {
	...
	lip := &crd.ProviderLeasedIP{
		TypeMeta: metav1.TypeMeta{
			Kind:       "providerleasedips.subnet.node",
			APIVersion: "v1",
		},
		...
		Spec: crd.ProviderLeasedIPSpec{
			LeaseID:      crd.LeaseIDFromSubnet(leaseID),
			ServiceName:  "aservice",
			Port:         101,
			ExternalPort: 100,
			SharingKey:   "akey",

...
import (
	...
	mlbmocks "github.com/unicornultrafoundation/subnet-node/core/k8s/kube/operators/clients/metallb/mocks"
...
func runIPOperator(t *testing.T, run bool, aobj []runtime.Object, prerun, fn func(ctx context.Context, s ipOperatorScaffold)) {
	...
	ctx = context.WithValue(ctx, fromctx.CtxKeyKubeClientSet, aclient.Interface(ac))

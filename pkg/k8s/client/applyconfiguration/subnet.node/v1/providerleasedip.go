...
func ProviderLeasedIP(name, namespace string) *ProviderLeasedIPApplyConfiguration {
	...
	b.WithAPIVersion("subnet.node/v1")
	return b
}
...
func (b *ProviderLeasedIPApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *ProviderLeasedIPApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ProviderLeasedIPApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *ProviderLeasedIPApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ProviderLeasedIPApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *ProviderLeasedIPApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {

...
type ResourcesApplyConfiguration struct {
	...
	Storage *subnetnodev1.ResourceStorage     `json:"storage,omitempty"`
}
...
func (b *ResourcesApplyConfiguration) WithStorage(value subnetnodev1.ResourceStorage) *ResourcesApplyConfiguration {
	b.Storage = &value
	return b
}

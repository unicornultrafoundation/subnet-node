...
func (b *ManifestApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *ManifestApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ManifestApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *ManifestApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ManifestApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *ManifestApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {

...
func (b *ProviderHostApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *ProviderHostApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ProviderHostApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *ProviderHostApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *ProviderHostApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *ProviderHostApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {

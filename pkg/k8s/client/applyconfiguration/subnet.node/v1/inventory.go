...
func (b *InventoryApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *InventoryApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *InventoryApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *InventoryApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *InventoryApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *InventoryApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {

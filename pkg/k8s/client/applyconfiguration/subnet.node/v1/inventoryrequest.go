...
func (b *InventoryRequestApplyConfiguration) WithCreationTimestamp(value apismetav1.Time) *InventoryRequestApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *InventoryRequestApplyConfiguration) WithDeletionTimestamp(value apismetav1.Time) *InventoryRequestApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
...
func (b *InventoryRequestApplyConfiguration) WithOwnerReferences(values ...*metav1.OwnerReferenceApplyConfiguration) *InventoryRequestApplyConfiguration {
	b.ensureObjectMetaApplyConfigurationExists()
	for i := range values {
		if values[i] == nil {

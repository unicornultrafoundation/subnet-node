...
func TestV2Parse_IP(t *testing.T) {
	sdl1, err := ReadFile("./_testdata/deployment/deployment-v2-ip-endpoint.yaml")
	require.NoError(t, err)
...
func TestV2Parse_SharedIP(t *testing.T) {
	...
	sdl1, err := ReadFile("./_testdata/deployment/deployment-v2-shared-ip-endpoint.yaml")
	require.NoError(t, err)
...
func TestV2Parse_MultipleIP(t *testing.T) {
	...
	sdl1, err := ReadFile("./_testdata/deployment/deployment-v2-multi-ip-endpoint.yaml")
	require.NoError(t, err)
...
func TestV2Parse_MultipleGroupsIP(t *testing.T) {
	...
	sdl1, err := ReadFile("./_testdata/deployment/deployment-v2-multi-groups-ip-endpoint.yaml")
	require.NoError(t, err)

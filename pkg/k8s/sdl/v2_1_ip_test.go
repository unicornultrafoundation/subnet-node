...
func TestV2_1_Parse_IP(t *testing.T) {
	sdl1, err := ReadFile("./_testdata/deployment/deployment-v2.1-ip-endpoint.yaml")
	require.NoError(t, err)
...
func TestV2_1_Parse_SharedIP(t *testing.T) {
	...
	sdl1, err := ReadFile("./_testdata/deployment/deployment-v2.1-shared-ip-endpoint.yaml")
	require.NoError(t, err)
...
func TestV2_1_Parse_MultipleIP(t *testing.T) {
	...
	sdl1, err := ReadFile("./_testdata/deployment/deployment-v2.1-multi-ip-endpoint.yaml")
	require.NoError(t, err)
...
func TestV2_1_Parse_MultipleGroupsIP(t *testing.T) {
	...
	sdl1, err := ReadFile("./_testdata/deployment/deployment-v2.1-multi-groups-ip-endpoint.yaml")
	require.NoError(t, err)

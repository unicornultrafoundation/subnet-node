...
type ManifestLister interface {
	...
	List(selector labels.Selector) (ret []*depinsubnetcomv1alpha1.Manifest, err error)
...
type manifestLister struct {
	listers.ResourceIndexer[*depinsubnetcomv1alpha1.Manifest]
}

// NewManifestLister returns a new ManifestLister.
func NewManifestLister(indexer cache.Indexer) ManifestLister {
	return &manifestLister{listers.New[*depinsubnetcomv1alpha1.Manifest](indexer, depinsubnetcomv1alpha1.Resource("manifest"))}
}

// Manifests returns an object that can list and get Manifests.
func (s *manifestLister) Manifests(namespace string) ManifestNamespaceLister {
	return manifestNamespaceLister{listers.NewNamespaced[*depinsubnetcomv1alpha1.Manifest](s.ResourceIndexer, namespace)}
}
...
type ManifestNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*depinsubnetcomv1alpha1.Manifest, error)

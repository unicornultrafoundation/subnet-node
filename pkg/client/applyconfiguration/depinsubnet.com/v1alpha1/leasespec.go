...
func (b *LeaseSpecApplyConfiguration) WithOwner(value string) *LeaseSpecApplyConfiguration {
	b.Owner = &value
	return b
}
...
func (b *LeaseSpecApplyConfiguration) WithID(value uint64) *LeaseSpecApplyConfiguration {
	b.ID = &value
	return b
}

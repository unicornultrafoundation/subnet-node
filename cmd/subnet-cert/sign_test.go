...
func Test_signCert(t *testing.T) {
	...
	caKeyF.Write(cert.MarshalSigningPrivateKeyToPEM(certp.Curve_CURVE25519, caPriv))
	...
	inPubF.Write(cert.MarshalPublicKeyToPEM(certp.Curve_CURVE25519, inPub))
	...
	caKeyF2.Write(cert.MarshalSigningPrivateKeyToPEM(certp.Curve_CURVE25519, caPriv2))
	...
	b, _ = cert.EncryptAndMarshalSigningPrivateKey(certp.Curve_CURVE25519, caPriv, passphrase, kdfParams)
	caKeyF.Write(b)

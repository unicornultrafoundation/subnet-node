...
func (m *PoWChallenge) Reset()         { *m = PoWChallenge{} }
func (m *PoWChallenge) String() string { return proto.CompactTextString(m) }
func (*PoWChallenge) ProtoMessage()    {}
func (*PoWChallenge) Descriptor() ([]byte, []int) {
	return fileDescriptor_99f1ba06460f9f71, []int{6}
}
func (m *PoWChallenge) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PoWChallenge) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PoWChallenge.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PoWChallenge) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PoWChallenge.Merge(m, src)
}
func (m *PoWChallenge) XXX_Size() int {
	return m.Size()
}
func (m *PoWChallenge) XXX_DiscardUnknown() {
	xxx_messageInfo_PoWChallenge.DiscardUnknown(m)
}

var xxx_messageInfo_PoWChallenge proto.InternalMessageInfo

func (m *PoWChallenge) GetChallenge() string {
	if m != nil {
		return m.Challenge
	}
	return ""
...
func (m *PoWResponse) GetResponse() string {
	if m != nil {
		return m.Response
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*PoWChallenge)(nil), "subnet.app.verifier.PoWChallenge")
...
var fileDescriptor_99f1ba06460f9f71 = []byte{
	...
	,
}
...
func (m *PoWChallenge) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PoWChallenge) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PoWChallenge) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *PoWChallenge) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PoWChallenge) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PoWChallenge: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PoWChallenge: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {

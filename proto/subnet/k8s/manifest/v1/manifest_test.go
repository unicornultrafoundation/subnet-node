...
import (
	...
	testutil "github.com/unicornultrafoundation/subnet-node/proto/subnet/k8s/testutil"
	utils "github.com/unicornultrafoundation/subnet-node/proto/subnet/k8s/utils"
)
...
var randUnits1 = subnettypes.Resources{
	ID: 1,
	CPU: &subnettypes.CPU{
		Units: subnettypes.NewResourceValue(randCPU1),
	},
	GPU: &subnettypes.GPU{
		Units: subnettypes.NewResourceValue(randGPU1),
	},
	Memory: &subnettypes.Memory{
		Quantity: subnettypes.NewResourceValue(randMemory),
	},
	Storage: subnettypes.Volumes{
		subnettypes.Storage{
			Quantity: subnettypes.NewResourceValue(randStorage),
		},
	},
	Endpoints: subnettypes.Endpoints{},
}

var randUnits3 = subnettypes.Resources{
	ID: 1,
	CPU: &subnettypes.CPU{
		Units: subnettypes.NewResourceValue(randCPU2),
	},
	Memory: &subnettypes.Memory{
		Quantity: subnettypes.NewResourceValue(randMemory),
	},
...
func simpleResources(exposes ServiceExposes) subnettypes.Resources {
	return subnettypes.Resources{
		ID: 1,
		CPU: &subnettypes.CPU{
			Units: subnettypes.ResourceValue{
				Val: utils.NewInt(int64(randCPU1)),
			},
			Attributes: nil,
		},
		Memory: &subnettypes.Memory{
		...
		GPU: &subnettypes.GPU{
			Units: subnettypes.ResourceValue{
				Val: utils.NewInt(int64(randGPU1)),
			},
			Attributes: nil,
		},
		Storage: subnettypes.Volumes{

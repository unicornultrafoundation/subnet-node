...
var (
	pattern_Query_Certificates_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 2, 5}, []string{"subnet", "k8s", "cert", "v1", "certificates", "list"}, "", runtime.AssumeColonVerbOpt(false)))
)

...
var fileDescriptor_a664dbe2d082945f = []byte{
	...
	0xe3, 0x0d, 0x18, 0x9d, 0x52, 0x4e, 0x3c, 0x92, 0x63, 0xbc, 0xf0, 0x48, 0x8e, 0xf1, 0xc1, 0x23,
	0x39, 0xc6, 0x09, 0x8f, 0xe5, 0x18, 0x2e, 0x3c, 0x96, 0x63, 0xb8, 0xf1, 0x58, 0x8e, 0x21, 0xca,
	0x2b, 0x3d, 0xb3, 0x24, 0xa3, 0x34, 0x49, 0x2f, 0x39, 0x3f, 0x57, 0xbf, 0x34, 0x2f, 0x33, 0x39,
	0xbf, 0x28, 0xaf, 0x34, 0xa7, 0xa4, 0x28, 0x31, 0x2d, 0xbf, 0x34, 0x2f, 0x05, 0x1c, 0x26, 0xfa,
	0x10, 0xc3, 0x75, 0xf3, 0xf2, 0x53, 0xa0, 0x61, 0x09, 0x15, 0xd1, 0xcf, 0xb6, 0x28, 0xd6, 0x47,
	0x0a, 0xa8, 0x24, 0x36, 0xb0, 0xac, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x43, 0xad, 0x04, 0x92,
	0xac, 0x01, 0x00, 0x00,
}
...
func (c *providerRPCClient) GetStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Status, error) {
	out := new(Status)
	err := c.cc.Invoke(ctx, "/subnet.k8s.provider.v1.ProviderRPC/GetStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *providerRPCClient) StreamStatus(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (ProviderRPC_StreamStatusClient, error) {
	stream, err := c.cc.NewStream(ctx, &_ProviderRPC_serviceDesc.Streams[0], "/subnet.k8s.provider.v1.ProviderRPC/StreamStatus", opts...)
	if err != nil {
		return nil, err
	}
...
func _ProviderRPC_GetStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/subnet.k8s.provider.v1.ProviderRPC/GetStatus",
	}

...
var (
	pattern_Query_Providers_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"subnet", "provider", "v1beta3", "providers"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Provider_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"subnet", "provider", "v1beta3", "providers", "owner"}, "", runtime.AssumeColonVerbOpt(false)))
)

...
func EncryptAndMarshalSigningPrivateKey(curve certp.Curve, b []byte, passphrase []byte, kdfParams *Argon2Parameters) ([]byte, error) {
	...
	b, err = proto.Marshal(&certp.RawNebulaEncryptedData{
		EncryptionMetadata: &certp.RawNebulaEncryptionMetadata{
			EncryptionAlgorithm: "AES-256-GCM",
			Argon2Parameters: &certp.RawNebulaArgon2Parameters{
...
func UnmarshalNebulaEncryptedData(b []byte) (*NebulaEncryptedData, error) {
	...
	var rned certp.RawNebulaEncryptedData
...
func unmarshalArgon2Parameters(params *certp.RawNebulaArgon2Parameters) (*Argon2Parameters, error) {

...
import (
	...
	"github.com/unicornultrafoundation/subnet-masternode/pkclient"
...
func (nc *certificateV1) Curve() certp.Curve {
...
func (nc *certificateV1) VerifyPrivateKey(curve certp.Curve, key []byte) error {
...
func (nc *certificateV1) getRawDetails() *certp.RawNebulaCertificateDetails {
	rd := &certp.RawNebulaCertificateDetails{
...
func unmarshalCertificateV1(b []byte, assertPublicKey bool) (*certificateV1, error) {
	...
	var rc certp.RawNebulaCertificate
...
func signV1(t *TBSCertificate, curve certp.Curve, key []byte, client *pkclient.PKClient) (*certificateV1, error) {
	c := &certificateV1{
		details: detailsV1{
			Name:      t.Name,
			Ips:       t.Networks,

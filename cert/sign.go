...
func (t *TBSCertificate) Sign(signer Certificate, curve certp.Curve, key []byte) (Certificate, error) {
	return t.sign(signer, curve, key, nil)
}

func (t *TBSCertificate) SignPkcs11(signer Certificate, curve certp.Curve, client *pkclient.PKClient) (Certificate, error) {
	if curve != certp.Curve_P256 {
...
func (t *TBSCertificate) sign(signer Certificate, curve certp.Curve, key []byte, client *pkclient.PKClient) (Certificate, error) {
	if curve != t.Curve {

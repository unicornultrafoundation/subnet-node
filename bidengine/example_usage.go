...
func ExampleWithCustomComponents() {
	...
	bidManager := NewBidManager(config, nil, logger, metrics, datastore, resourceManager, pricingEngine) // nil for bidMarket contract
	orderMonitor := NewOrderMonitor(config, nil, logger, metrics, datastore, bidManager)                 // nil for bidMarket contract

...
func Test_NewConnectionManagerTest_DisconnectInvalid(t *testing.T) {
	...
	caCert, err := tbs.Sign(nil, certp.Curve_CURVE25519, privCA)
	...
	peerCert, err := tbs.Sign(caCert, certp.Curve_CURVE25519, privCA)
	assert.NoError(t, err)
...
func (d *dummyCert) Curve() certp.Curve {
	return d.curve
}
...
func (d *dummyCert) Sign(curve certp.Curve, key []byte) error {
	return nil
}
...
func (d *dummyCert) VerifyPrivateKey(curve certp.Curve, key []byte) error {
	return nil
}

...
// Start actually runs subnet, this is a nonblocking call. To block use Control.ShutdownBlock()
...
// Stop signals subnet to shutdown and close all tunnels, returns after the shutdown is complete
func (c *Control) Stop() {

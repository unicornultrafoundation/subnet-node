...
import (
	...
	"github.com/unicornultrafoundation/subnet-node/common/iputil"
	"github.com/unicornultrafoundation/subnet-node/common/noiseutil"
...
func (f *Interface) consumeInsidePacket(packet []byte, fwPacket *firewall.Packet, nb, out []byte, q int, localCache firewall.ConntrackCache) {
	...
	if fwPacket.RemoteIP == f.myVpnNet.Addr() {
		...
		// routes packets from the subnet IP to the subnet IP through the subnet
		// TUN device.
		...
		// routes packets from the subnet IP to the subnet IP through the loopback device.
		return
	}
...
func (f *Interface) SendVia(via *HostInfo,
	...
	// The payload consists of the inner, unencrypted subnet header, as well as the end-to-end encrypted payload.

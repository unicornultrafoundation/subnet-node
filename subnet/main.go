...
import (
	...
	"github.com/unicornultrafoundation/subnet-node/core/overlay"
	"github.com/unicornultrafoundation/subnet-node/core/sshd"
...
func Main(c *config.C, configTest bool, buildVersion string, logger *logrus.Logger, deviceFactory overlay.DeviceFactory) (retcon *Control, reterr error) {
	...
	// Start DNS server last to allow using the subnet IP as lighthouse.dns.host
	var dnsStart func()

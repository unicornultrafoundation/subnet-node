...
func UptimeService(lc fx.Lifecycle, repo repo.Repo, appService *apps.Service, pubSub *pubsub.PubSub, cfg *config.C, id peer.ID, P2P *p2p.P2P) *uptime.UptimeService {

...
This example demonstrates how to deploy a simple HTTP echo service using the k8s-cluster package. The example shows the complete lifecycle of a deployment, from creation to cleanup.
...
3. Start the k8s-cluster service

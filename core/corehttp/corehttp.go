...
type ServeOption func(*core.SubnetNode, net.Listener, *http.ServeMux) (*http.ServeMux, error)

// MakeHandler turns a list of ServeOptions into a http.Handler that implements
// all of the given options, in order.
func MakeHandler(n *core.SubnetNode, l net.Listener, options ...ServeOption) (http.Handler, error) {
...
func ListenAndServe(n *core.SubnetNode, listeningMultiAddr string, options ...ServeOption) error {
...
func Serve(node *core.SubnetNode, lis net.Listener, options ...ServeOption) error {

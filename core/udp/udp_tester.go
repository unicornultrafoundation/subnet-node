...
type TesterConn struct {
	Addr netip.AddrPort
	subnet
	RxPackets chan *Packet // Packets to receive into subnet
	TxPackets chan *Packet // Packets transmitted outside by subnet
...
// Send will place a UdpPacket onto the receive queue for subnet to consume
// this is an encrypted packet or a handshake message in most cases
// packets were transmitted from another subnet node, you can send them with Tun.Send
...
// subnet meant to send this message on the network, it will be encrypted
...
//********************************************************************************************************************//
// Below this is boilerplate implementation to make subnet actually work
//********************************************************************************************************************//

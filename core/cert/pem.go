...
const (
	CertificateBanner                = "SUBNET CERTIFICATE"
	CertificateV2Banner              = "SUBNET CERTIFICATE V2"
	X25519PrivateKeyBanner           = "SUBNET X25519 PRIVATE KEY"
	X25519PublicKeyBanner            = "SUBNET X25519 PUBLIC KEY"
	EncryptedEd25519PrivateKeyBanner = "SUBNET ED25519 ENCRYPTED PRIVATE KEY"
	Ed25519PrivateKeyBanner          = "SUBNET ED25519 PRIVATE KEY"
	Ed25519PublicKeyBanner           = "SUBNET ED25519 PUBLIC KEY"

	P256PrivateKeyBanner               = "SUBNET P256 PRIVATE KEY"
	P256PublicKeyBanner                = "SUBNET P256 PUBLIC KEY"
	EncryptedECDSAP256PrivateKeyBanner = "SUBNET ECDSA P256 ENCRYPTED PRIVATE KEY"
	ECDSAP256PrivateKeyBanner          = "SUBNET ECDSA P256 PRIVATE KEY"
)
...
func MarshalPublicKeyToPEM(curve certp.Curve, b []byte) []byte {
	switch curve {
...
func UnmarshalPublicKeyFromPEM(b []byte) ([]byte, []byte, certp.Curve, error) {
	k, r := pem.Decode(b)
	if k == nil {
...
func MarshalPrivateKeyToPEM(curve certp.Curve, b []byte) []byte {
	switch curve {
	case certp.Curve_CURVE25519:
...
func MarshalSigningPrivateKeyToPEM(curve certp.Curve, b []byte) []byte {
	switch curve {
	case certp.Curve_CURVE25519:
...
func UnmarshalPrivateKeyFromPEM(b []byte) ([]byte, []byte, certp.Curve, error) {
	k, r := pem.Decode(b)
	if k == nil {
		return nil, r, 0, fmt.Errorf("input did not contain a valid PEM encoded block")
	}
...
func UnmarshalSigningPrivateKeyFromPEM(b []byte) ([]byte, []byte, certp.Curve, error) {
	k, r := pem.Decode(b)
	if k == nil {
		return nil, r, 0, fmt.Errorf("input did not contain a valid PEM encoded block")
	}
	...
	case EncryptedEd25519PrivateKeyBanner:
		return nil, nil, certp.Curve_CURVE25519, ErrPrivateKeyEncrypted
	case EncryptedECDSAP256PrivateKeyBanner:
		return nil, nil, certp.Curve_P256, ErrPrivateKeyEncrypted

...
// input bytes, which must be a PEM-encoded set of subnet certificates.
...
// AddCAFromPEM verifies a Subnet CA certificate and adds it to the pool.
...
// AddCA verifies a Subnet CA certificate and adds it to the pool.

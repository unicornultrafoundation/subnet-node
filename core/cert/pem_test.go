...
func TestUnmarshalCertificateFromPEM(t *testing.T) {
	goodCert := []byte(`
# A good cert
-----BEGIN SUBNET CERTIFICATE-----
CkAKDm5lYnVsYSByb290IGNhKJfap9AFMJfg1+YGOiCUQGByMuNRhIlQBOyzXWbL
vcKBwDhov900phEfJ5DN3kABEkDCq5R8qBiu8sl54yVfgRcQXEDt3cHr8UTSLszv
bzBEr00kERQxxTzTsH8cpYEgRoipvmExvg8WP8NdAJEYJosB
-----END SUBNET CERTIFICATE-----
`)
	badBanner := []byte(`# A bad banner
-----BEGIN NOT A SUBNET CERTIFICATE-----
CkAKDm5lYnVsYSByb290IGNhKJfap9AFMJfg1+YGOiCUQGByMuNRhIlQBOyzXWbL
vcKBwDhov900phEfJ5DN3kABEkDCq5R8qBiu8sl54yVfgRcQXEDt3cHr8UTSLszv
bzBEr00kERQxxTzTsH8cpYEgRoipvmExvg8WP8NdAJEYJosB
-----END NOT A SUBNET CERTIFICATE-----
`)
...
-----BEGIN SUBNET ED25519 PRIVATE KEY-----
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA==
-----END SUBNET ED25519 PRIVATE KEY-----
`)
	privP256Key := []byte(`# A good key
-----BEGIN SUBNET ECDSA P256 PRIVATE KEY-----
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=
-----END SUBNET ECDSA P256 PRIVATE KEY-----
`)
...
-----BEGIN NOT A SUBNET PRIVATE KEY-----
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA==
-----END NOT A SUBNET PRIVATE KEY-----
`)
	invalidPem := []byte(`# Not a valid PEM format
-BEGIN SUBNET ED25519 PRIVATE KEY-----
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA==
-END SUBNET ED25519 PRIVATE KEY-----`)
	...
	assert.Equal(t, certp.Curve_CURVE25519, curve)
	assert.Nil(t, err)
	...
	assert.Equal(t, certp.Curve_P256, curve)
	assert.Nil(t, err)
...
func TestUnmarshalPrivateKeyFromPEM(t *testing.T) {
	privKey := []byte(`# A good key
-----BEGIN SUBNET X25519 PRIVATE KEY-----
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=
-----END SUBNET X25519 PRIVATE KEY-----
`)
	privP256Key := []byte(`# A good key
-----BEGIN SUBNET P256 PRIVATE KEY-----
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=
-----END SUBNET P256 PRIVATE KEY-----
`)
	shortKey := []byte(`# A short key
-----BEGIN SUBNET X25519 PRIVATE KEY-----
...
-----BEGIN SUBNET ED25519 PUBLIC KEY-----
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=
-----END SUBNET ED25519 PUBLIC KEY-----
`)
	shortKey := []byte(`# A short key
-----BEGIN SUBNET ED25519 PUBLIC KEY-----
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA==
...
`)
	invalidBanner := []byte(`# Invalid banner
-----BEGIN NOT A SUBNET PUBLIC KEY-----
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=
-----END NOT A SUBNET PUBLIC KEY-----
`)
	invalidPem := []byte(`# Not a valid PEM format
-BEGIN SUBNET ED25519 PUBLIC KEY-----
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=
...
func TestUnmarshalX25519PublicKey(t *testing.T) {
	pubKey := []byte(`# A good key
-----BEGIN SUBNET X25519 PUBLIC KEY-----
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA=
-----END SUBNET X25519 PUBLIC KEY-----
`)
	pubP256Key := []byte(`# A good key
-----BEGIN SUBNET P256 PUBLIC KEY-----
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
AAAAAAAAAAAAAAAAAAAAAAA=
-----END SUBNET P256 PUBLIC KEY-----
`)
	shortKey := []byte(`# A short key
-----BEGIN SUBNET X25519 PUBLIC KEY-----
AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA==

...
-----BEGIN SUBNET ED25519 ENCRYPTED PRIVATE KEY-----
CjwKC0FFUy0yNTYtR0NNEi0IExCAgIABGAEgBCognnjujd67Vsv99p22wfAjQaDT
oCMW1mdjkU3gACKNW4MSXOWR9Sts4C81yk1RUku2gvGKs3TB9LYoklLsIizSYOLl
+Vs//O1T0I1Xbml2XBAROsb/VSoDln/6LMqR4B6fn6B3GOsLBBqRI8daDl9lRMPB
qrlJ69wer3ZUHFXA
-----END SUBNET ED25519 ENCRYPTED PRIVATE KEY-----
`)
...
`)
	...
	curve, k, rest, err = DecryptAndUnmarshalSigningPrivateKey(passphrase, rest)
	assert.EqualError(t, err, "bytes did not contain a proper subnet encrypted Ed25519/ECDSA private key banner")
	assert.Nil(t, k)
...
func TestEncryptAndMarshalSigningPrivateKey(t *testing.T) {
	...
	key, err := EncryptAndMarshalSigningPrivateKey(certp.Curve_CURVE25519, bytes, passphrase, kdfParams)
	assert.Nil(t, err)

...
func (nc *certificateV1) getRawDetails() *certp.RawSubnetCertificateDetails {
	rd := &certp.RawSubnetCertificateDetails{
...
// unmarshalCertificateV1 will unmarshal a protobuf byte representation of a Subnet cert
func unmarshalCertificateV1(b []byte, assertPublicKey bool) (*certificateV1, error) {
	if len(b) == 0 {
		return nil, fmt.Errorf("nil byte array")
	}
	var rc certp.RawSubnetCertificate

...
func (_m *Client) GetDeclaredIPs(ctx context.Context, leaseID v1beta4.LeaseID) ([]subnet_networkv2beta2.ProviderLeasedIPSpec, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, v1beta4.LeaseID) ([]subnet_networkv2beta2.ProviderLeasedIPSpec, error)); ok {
		return rf(ctx, leaseID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, v1beta4.LeaseID) []subnet_networkv2beta2.ProviderLeasedIPSpec); ok {
		r0 = rf(ctx, leaseID)
	} else {
		if ret.Get(0) != nil {
...
func (_c *Client_GetDeclaredIPs_Call) Return(_a0 []subnet_networkv2beta2.ProviderLeasedIPSpec, _a1 error) *Client_GetDeclaredIPs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Client_GetDeclaredIPs_Call) RunAndReturn(run func(context.Context, v1beta4.LeaseID) ([]subnet_networkv2beta2.ProviderLeasedIPSpec, error)) *Client_GetDeclaredIPs_Call {
	_c.Call.Return(run)
	return _c
}

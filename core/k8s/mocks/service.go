...
import (
	...
	deploymentv1beta3 "github.com/unicornultrafoundation/subnet-node/proto/subnet/k8s/deployment/v1"

	rest "github.com/unicornultrafoundation/subnet-node/core/k8s/types/v1/provider/client"

	v1 "github.com/unicornultrafoundation/subnet-node/proto/subnet/k8s/provider/v1"
...
func (_m *Service) FindActiveLease(ctx context.Context, owner common.Address, dseq uint64, gseq uint32) (bool, v1beta4.LeaseID, v2beta2.ManifestGroup, error) {
	...
	var r3 error
	if rf, ok := ret.Get(0).(func(context.Context, common.Address, uint64, uint32) (bool, v1beta4.LeaseID, v2beta2.ManifestGroup, error)); ok {
		return rf(ctx, owner, dseq, gseq)
	}
	if rf, ok := ret.Get(0).(func(context.Context, common.Address, uint64, uint32) bool); ok {
		r0 = rf(ctx, owner, dseq, gseq)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, common.Address, uint64, uint32) v1beta4.LeaseID); ok {
		r1 = rf(ctx, owner, dseq, gseq)
	} else {
		r1 = ret.Get(1).(v1beta4.LeaseID)
	}

	if rf, ok := ret.Get(2).(func(context.Context, common.Address, uint64, uint32) v2beta2.ManifestGroup); ok {
		r2 = rf(ctx, owner, dseq, gseq)
	} else {
		r2 = ret.Get(2).(v2beta2.ManifestGroup)
	}

	if rf, ok := ret.Get(3).(func(context.Context, common.Address, uint64, uint32) error); ok {
...
func (_c *Service_FindActiveLease_Call) Run(run func(ctx context.Context, owner common.Address, dseq uint64, gseq uint32)) *Service_FindActiveLease_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(common.Address), args[2].(uint64), args[3].(uint32))
	})
	return _c
}
...
func (_c *Service_FindActiveLease_Call) RunAndReturn(run func(context.Context, common.Address, uint64, uint32) (bool, v1beta4.LeaseID, v2beta2.ManifestGroup, error)) *Service_FindActiveLease_Call {
	_c.Call.Return(run)
	return _c
}

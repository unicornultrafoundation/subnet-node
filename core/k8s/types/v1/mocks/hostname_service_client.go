...
func (_m *HostnameServiceClient) CanReserveHostnames(hostnames []string, ownerAddr common.Address) error {
...
func (_c *HostnameServiceClient_CanReserveHostnames_Call) Run(run func(hostnames []string, ownerAddr common.Address)) *HostnameServiceClient_CanReserveHostnames_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]string), args[1].(common.Address))
	})
	return _c
}
...
func (_c *HostnameServiceClient_CanReserveHostnames_Call) RunAndReturn(run func([]string, common.Address) error) *HostnameServiceClient_CanReserveHostnames_Call {
	_c.Call.Return(run)
	return _c
}
